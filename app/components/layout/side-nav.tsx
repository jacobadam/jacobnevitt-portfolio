      ...
      <header className="flex flex-col max-w-2xl 3xl:max-w-5xl pt-4 lg:pb-12 lg:my-18 mb-10 lg:mb-16">
        ...
        <div className="flex flex-row gap-4 mb-5 lg:mb-8">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              className="w-6 h-6 2xl:w-8 2xl:h-8 fill-primary-foreground hover:fill-secondary transition-colors duration-200"
            >
        ...
        <a
          href="/Jacob_Nevitt_CV_2026_FE.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="group relative flex w-fit items-center gap-1 rounded-full border border-white/10 bg-white/5 px-3 py-2.5 font-medium text-xs 2xl:text-base uppercase tracking-widest text-amber-500  transition-all hover:bg-white/10 hover:border-white/20 active:scale-95"
        >
          ...
          {navLinks.map((item, index) => (
            <li key={index}>
              ...
              >
                ...
                ></span>
                <span
                  className={`uppercase text-xs 2xl:text-base tracking-widest transition-colors duration-300 font-semibold ${
                    activeSection === item.href
                      ? "text-secondary"
